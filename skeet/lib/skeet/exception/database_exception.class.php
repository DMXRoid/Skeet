...
The query was: " . $databaseObject->getQuery();
			...
			$message .= "
			Query is: " . $databaseObject->getQuery() . " 
The error is: " . $databaseObject->getError();
